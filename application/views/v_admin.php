        ...
        <div class="row ">
          ...
          <form class="form-group " role=”form“ action="#" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row ">
              ...
              <div class="col-xs-10">
                <input class="form-control" type="text" placeholder="moh...." id="example-text-input" name="namaphoto">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-xs-10">
                <input class="form-control" type="url" placeholder="https://github.com/jolabti" id="example-url-input" name="socmedphoto">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-xs-10">
                <input class="form-control" type="tel" value="1-(555)-555-5555" id="example-tel-input" name="telponphoto">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-xs-10">
                <input class="form-control" type="text" placeholder="ex.2016" id="example-password-input" name="angkatanphoto">
              </div>
            </div>
